<template>
  <div>
    <full-page :options="options" ref="fullpage">
      <div class="section">
        <img :src="require('@/../static/img/Car_img/porsche-image.webp')" alt="">
      </div>
      <div class="section footerH">
        <img :src="require('@/../static/img/Car_img/porsche-image_02.webp')" alt="">
      </div>
      <div class="section footerH">
        <img :src="require('@/../static/img/Car_img/porsche-image_03.webp')" alt="">
      </div>
    </full-page>
  </div>
</template>
