...
<!--                <h1>技术数据</h1>-->
          ...
          <el-drawer
              ...
              :before-close="handleClose">
            <div id="line1"></div>
            <img :src="require('/static/img/Car_img/porsche-svg.svg')" id="Porche2" alt="">
            <div id="line2"></div>
            <div id="ControlContent">
              <div class="content">
                <p style="font-size: 14px;width: 480px;margin-top: 30px">* 所列的制造商建议零售价（含增值税）仅供参考，并不包括运输费用、税费（另有明确规定的除外）、牌照、所有权、非强制或地区性要求的设备。特别是，制造商建议零售价（含增值税）并未包含 2016 年 12 月 1 日起生效的《财政部、国家税务总局关于对超豪华小汽车加征消费税有关事项的通知》所要求加征的消费税。根据《关于深化增值税改革有关政策的公告》，自 2019 年 4 月 1 日起增值税税率进行调整。因此所列的厂商建议零售价将可能进行调整。请您与保时捷授权经销商咨询具体的价格信息。
                </p>
              </div>
              <div class="content">
                <h2 style="font-weight: 700;font-size: 20px">数据保护声明</h2>
                ...
                <h1 style="margin-left: -250px">阅读即代表同意隐私协议</h1>
                <el-button type="danger" @click="buy(CarData.name,CarData.price)" style="margin-top: 10px">向经销商提交提交购买</el-button>
              </div>
              <div class="content">
                <h2 style="font-weight: 700;font-size: 20px">我的{{CarData.name}}</h2>
                <img :src="CarData.carimage" alt="">
                <span id="price3" style="margin-left: -20px">总价:{{CarData.price}} 元</span>
              </div>
            </div>
          </el-drawer>
          <div class="meta">
...
@import "../../static/css/purchase2.css";
/*img{*/
